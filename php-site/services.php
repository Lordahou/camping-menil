...
<main>
  ...
  <section class="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <p class="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto font-light">Tout pour un séjour confortable au bord de la Mayenne</p>
    </div>
  </section>
  ...
  <section class="py-20 lg:py-28 bg-cream-dark reveal">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          <h3 class="font-heading text-2xl text-forest mb-6">Sanitaires</h3>
          <p class="text-gray-600 leading-relaxed mb-4">Le bloc sanitaire du camping est nettoyé quotidiennement et comprend :</p>
  ...
  <section class="py-20 lg:py-28 bg-white reveal">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto text-center">
        ...
        <p class="text-gray-600 text-lg leading-relaxed mb-8">Le Camping du Bac est engagé pour l'accessibilité des personnes à mobilité réduite.</p>
