...
<footer class="bg-forest text-white/80">
  ...
  <div class="border-t border-white/10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-wrap items-center justify-center gap-8">
      <a href="https://www.lavelofrancette.com/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-white/60 hover:text-sage transition-colors duration-200">
        <svg class="w-5 h-5 text-sage" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="18.5" cy="17.5" r="3.5"/><circle cx="5.5" cy="17.5" r="3.5"/><path d="M15 6a1 1 0 100-2 1 1 0 000 2zm1 1.5l-3 4.5h4l2 4.5M5.5 17.5L8 10l4 2 3-3.5"/></svg>
        <span class="text-sm font-medium">Vélo Francette</span>
      </a>
      <a href="https://www.francevelotourisme.com/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-white/60 hover:text-sage transition-colors duration-200">
        <svg class="w-5 h-5 text-sage" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="18.5" cy="17.5" r="3.5"/><circle cx="5.5" cy="17.5" r="3.5"/><path d="M15 6a1 1 0 100-2 1 1 0 000 2zm1 1.5l-3 4.5h4l2 4.5M5.5 17.5L8 10l4 2 3-3.5"/></svg>
        <span class="text-sm font-medium">France Vélo Tourisme</span>
      </a>
      <a href="http://www.sudmayenne.com/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-white/60 hover:text-sage transition-colors duration-200">
        <svg class="w-5 h-5 text-sage" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
        <span class="text-sm font-medium">Sud Mayenne Tourisme</span>
      </a>
      <span class="border-l border-white/20 h-6"></span>
      <a href="https://www.menil53.fr/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity duration-200" title="Commune de Ménil">
        <img src="/images/logos/commune-menil.jpg" alt="Commune de Ménil" class="h-8 w-8 rounded object-contain bg-white/90" loading="lazy" />
      </a>
      <a href="https://www.facebook.com/CampingBacMenil/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-white/60 hover:text-[#1877F2] transition-colors duration-200" title="Facebook — Camping du Bac de Ménil">
